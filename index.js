...
document.addEventListener('DOMContentLoaded', function () {
        /* =================================
     * 🔒 সেশন ট্র্যাকিং: মূল ওয়েবসাইটে প্রবেশের প্রমাণ
     * ================================= */
    // ইউজার মূল ওয়েবসাইটে প্রবেশ করলেই sessionStorage-এ সিক্রেট সেশন সেভ হবে
    sessionStorage.setItem("PHS_VISITED_MAIN_SITE", "true");
