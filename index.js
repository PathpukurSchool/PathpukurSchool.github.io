document.addEventListener('DOMContentLoaded', function () {
    ...
    function showAvailableSoonMessage(element) {
        ...
        msg.style.cssText = `
            color: #990000; /* গাঢ় লাল রং, কিন্তু খুবই তীব্র নয় */
            background-color: #FFF2F2; /* খুব হালকা গোলাপী/লাল ব্যাকগ্রাউন্ড */
            border: 2px solid #FFCCCC; /* হালকা লাল রঙের সামান্য মোটা বর্ডার */
            box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); /* হালকা ছায়া যোগ করা হলো */
            padding: 8px 15px; /* প্যাডিং বাড়ানো হলো */
            border-radius: 8px; /* বর্ডার রেডিয়াস সামান্য বাড়ানো হলো */
            font-weight: 600; /* ফন্ট ওয়েট সামান্য কমানো হলো (Bold এর চেয়ে কম) */
            font-size: 14px; /* ফন্টের আকার সামান্য কমানো হলো, যা আধুনিক ডিজাইনে চলে */
            text-align: center; 
            margin: 10px 0; /* মার্জিন বাড়ানো হলো */
            width: 100%;
            display: block;
            transition: all 0.3s ease; /* হালকা ট্রানজিশন যোগ করা হলো */
        `;
