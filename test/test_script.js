...
function initSection1_TeacherLinks() {
...
function initSection2_StudentLinks() {
    const table = document.getElementById('table-link-student');
    const tbody = table?.querySelector('tbody');
    const paginationContainer = document.getElementById('pagination-link-student');
    ...
    const columnNames = ["Class", "URL", "Action"];
    const classes = [
        "V_1ST", "V_2ND", "V_3RD", "VI_1ST", "VI_2ND", "VI_3RD",
        "VII_1ST", "VII_2ND", "VII_3RD", "VIII_1ST", "VIII_2ND", "VIII_3RD",
        "IX_1ST", "IX_2ND", "IX_3RD", "X_1ST", "X_2ND", "X_TEST",
    ...
    const allDataRows = classes.map(cls => ({ Class: cls, URL: '' }));
    ...
    renderTable();
                          ...
                          // ✅ ভবিষ্যতের সেকশন যোগ করতে চাইলে নিচের মত কল করুন:
    // initSection3_XXXX();
    // initSection4_XXXX();
    // ...
    // initSection9_XXXX();
