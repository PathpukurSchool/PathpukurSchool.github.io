document.addEventListener('DOMContentLoaded', () => {
    ...
    // masterConfig.json থেকে শংসাপত্র লোড করার ফাংশন
    ...
    // অবিলম্বে লগইন মডেল দেখান এবং শংসাপত্র লোড করুন
    loginModal.style.display = 'flex'; // মডেলটি দৃশ্যমান নিশ্চিত করুন
    loadCredentials();
    ...
    loginBtn.addEventListener('click', () => {
        ...
        if (enteredID === correctID && enteredPassword === correctPassword) {
            ...
            setTimeout(() => {
                ...
                initializePageContent(); // আপনার বিদ্যমান পৃষ্ঠা ইনিশিয়ালাইজেশন ফাংশন কল করুন
    ...
    function initializePageContent() {
        // --- START: আপনার দেওয়া upload_student_notice.js এর সম্পূর্ণ কোড এখান থেকে শুরু ---
        ...
        // Initial Render
        // document.addEventListener('DOMContentLoaded', () => { // এটি সরান, কারণ পুরো কোডটি DOMContentLoaded এর মধ্যেই আছে
        ...
        function attachInputEventListeners(rowElement) {
            ...
            if (dateInput) {
                dateInput.addEventListener('click', (e) => {
                    ...
                    if (inputDateStr) {
                        ...
                        if (parts.length === 3) {
                            // currentDay = parseInt(parts[0]); // এই লাইনটির প্রয়োজন নেই, শুধু মাস ও বছর প্রয়োজন
            ...
            rowElement.querySelectorAll('input[type="text"]:not(.input-date)').forEach(input => {
                input.addEventListener('click', (e) => {
                    ...
                    // আগের এই জটিল কোডটি সরিয়ে সহজ কোড যোগ করা হয়েছে:
