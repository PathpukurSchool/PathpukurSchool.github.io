...
let credentials = null; // শুরুতে null রাখছি
let schoolName = "";
...
fetch('master.json')
    ...
    .catch(err => {
        ...
        document.getElementById('message').textContent = "Configuration missing. Contact admin.";
...
document.getElementById('loginBtn').addEventListener('click', function () {
    ...
    // JSON লোড না হলে
    if (!credentials) {
        messageEl.textContent = "Configuration missing. Contact admin.";
    ...
    // ফাঁকা ইনপুট চেক
    if (!userId || !password) {
        messageEl.textContent = "Please enter ID and Password before submitting.";
        messageEl.className = "error";
        return;
    }
