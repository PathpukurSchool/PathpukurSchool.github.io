...
// ১. HTML এলিমেন্ট নির্বাচন করা
const darkModeToggle = document.getElementById('darkModeToggle');
const body = document.body;
const toggleText = darkModeToggle.textContent;

// ২. ব্যবহারকারীর সংরক্ষিত থিম লোড করা
// যদি localStorage-এ 'dark' থিম সংরক্ষিত থাকে, তবে সেই মোডটি চালু করা হবে
function loadTheme() {
    ...
    if (savedTheme === 'dark') {
        ...
        // Light Mode ডিফল্ট বা সংরক্ষিত
        body.classList.remove('dark-mode');
        darkModeToggle.textContent = 'Dark Mode';
    }
}

// ৩. থিম টগল করার ফাংশন
function toggleDarkMode() {
    // বডিতে 'dark-mode' ক্লাস আছে কি না তা পরীক্ষা করা
    const isDarkMode = body.classList.toggle('dark-mode');

    // বোতামের লেখা পরিবর্তন করা
    if (isDarkMode) {
        darkModeToggle.textContent = 'Light Mode';
...
// ৪. ইভেন্ট লিসেনার যুক্ত করা
darkModeToggle.addEventListener('click', toggleDarkMode);

// ৫. পেজ লোড হওয়ার সাথে সাথেই থিম লোড করা
