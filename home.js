...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // ১. বোতামটি লুকিয়ে ফেলুন
    button.style.display = 'none';

    // ২. একটি নতুন এলিমেন্ট তৈরি করা
    const message = document.createElement('div');
    message.className = 'avail-msg';
    message.textContent = '(🔔 Available Soon 🔔)';
    
    // ৩. নতুন এলিমেন্টটি বোতামের parent element-এর মধ্যে যোগ করুন
    // এতে মেসেজটি বোতামের জায়গায় প্রদর্শিত হবে
    button.parentNode.appendChild(message);

    // ৪. 3 সেকেন্ড পরে মেসেজটি মুছে ফেল
    setTimeout(() => {
        message.remove();
        // ৫. মেসেজ মুছে ফেলার পর বোতামটি আবার দৃশ্যমান করুন
